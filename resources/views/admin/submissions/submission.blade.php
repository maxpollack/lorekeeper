        ...
        @if ($submission->status == 'Pending')
            ...
            @if (Auth::check() && $submission->staff_comments && ($submission->user_id == Auth::user()->id || Auth::user()->hasPower('manage_submissions')))
                ...
                @if ($submission->status == 'Pending')
                    ...
                    <h2>Rewards</h2>
                    <<<<<<< HEAD @include('widgets._loot_select', ['loots' => $submission->rewards, 'showLootTables' => true, 'showRaffles' => true, 'showRecipes' => true]) @if ($submission->prompt_id)
                        =======
                        ...
                        <div id="characterComponents" class="hide">
                            ...
                            <table>
                                <tr class="character-reward-row">
                                    ...
                                    <<<<<<< HEAD <td class="d-flex align-items-center">
            ...
            @section('scripts')
                <<<<<<< HEAD @parent @if ($submission->status == 'Pending')
