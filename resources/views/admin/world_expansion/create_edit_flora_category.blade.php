...
@section('admin-content')
    {!! breadcrumbs([
        'Admin Panel' => 'admin',
        'Flora Categories' => 'admin/world/flora-categories',
        ($category->id ? 'Edit' : 'Create') . ' Flora Category' => $category->id ? 'admin/world/flora-categories/edit/' . $category->id : 'admin/world/flora-categories/create',
    ]) !!}
